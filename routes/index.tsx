...
<h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-center tracking-widest font-[Permanent_Marker]">
  Hungry for the Best
</h1>
...
<div className="text-lg md:text-xl lg:text-3xl xl:text-5xl 2xl:text-6xl font-[Changa_One]">Tiki Bars</div>
    ...
    <a href="/tiki" className="btn btn-square btn-ghost md:btn-lg">
  <svg
